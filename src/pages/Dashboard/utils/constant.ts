export const users: any = [
  ...
  { id: 6, name: "Doe", age: 40, country: "USA", email: "doe@example.com" },
];
...
export const usersColumns = [
  ...
  export const generateRowId = (length = 8) => {
  ...
  const authorization_token :any= process.env.REACT_APP_AUTHORIZATION_TOKEN;
  export const autoToken: string | null = localStorage.getItem(authorization_token);
